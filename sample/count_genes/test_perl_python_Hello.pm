...
sub pipeline_analyses {
  ...
  return [
      ...
      {   
      	  # before you need:  
      	  # export PYTHONPATH="/nfs/production/panda/ensembl/kbillis/python_in_hive/ensembl-genes/sample/count_genes/:/nfs/production/panda/ensembl/kbillis/code/python/modules/:/nfs/production/panda/ensembl/kbillis/code/python/modules/lib/python2.7/site-packages/"
