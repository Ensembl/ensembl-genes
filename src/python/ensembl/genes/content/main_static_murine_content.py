...
def write_content(info, out_dir, url_path, species_strain):
    ...
    with open(  # pylint: disable=unspecified-encoding
        ...
        print(
            ...
            f'genes and transcripts via the <a href="https://ensembl.org/help/articles/human-genome-automated-annotation">Ensembl Human automated annotation system</a>, supplemented by methods from the '  # pylint: disable=line-too-long
            f'<a href="https://ensembl.org/help/articles/vertebrate-genome-annotation">Ensembl vertebrate annotation pipeline</a>. '  # pylint: disable=line-too-long
