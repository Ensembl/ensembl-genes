...
my $ftp_base = 'ftp://ftp.ncbi.nlm.nih.gov/genomes/all';
  ...
  my %coding_stats_hash = ('genebuild.coding_genes' => $$coding_stats[1],
                           'genebuild.average_genomic_span' => $$coding_stats[2],
                           'genebuild.average_sequence_length' => $$coding_stats[3],
                           'genebuild.average_cds_length' => $$coding_stats[4],
                           'genebuild.shortest_gene_length' => $$coding_stats[5],
                           'genebuild.longest_gene_length' => $$coding_stats[6],
                           'genebuild.total_transcripts' => $$coding_stats[7],
                           'genebuild.coding_transcripts' => $$coding_stats[8],
                           'genebuild.transcripts_per_gene' => $$coding_stats[9],
                           'genebuild.coding_transcripts_per_gene' => $$coding_stats[10],
                           'genebuild.total_exons' => $$coding_stats[11],
                           'genebuild.total_coding_exons' => $$coding_stats[12],
                           'genebuild.average_exon_length' => $$coding_stats[13],
                           'genebuild.average_coding_exon_length' => $$coding_stats[14],
                           'genebuild.average_coding_exons_per_transcript'=> $$coding_stats[15],
                           'genebuild.average_coding_exons_per_coding_transcript'=> $$coding_stats[16],
                           'genebuild.total_introns' => $$coding_stats[17],
                           'genebuild.average_intron_length' => $$coding_stats[18]);

  my %noncoding_stats_hash = ('genebuild.nc_non_coding_genes' => $$non_coding_stats[1],
                              'genebuild.nc_small_non_coding_genes'  => $$non_coding_stats[2],
                              'genebuild.nc_long_non_coding_genes' => $$non_coding_stats[3],
                              'genebuild.nc_misc_non_coding_genes' => $$non_coding_stats[4],
                              'genebuild.nc_average_genomic_span' => $$non_coding_stats[5],
                              'genebuild.nc_average_sequence_length' => $$non_coding_stats[6],
                              'genebuild.nc_shortest_gene_length' => $$non_coding_stats[7],
                              'genebuild.nc_longest_gene_length' => $$non_coding_stats[8],
                              'genebuild.nc_total_transcripts' => $$non_coding_stats[9],
                              'genebuild.nc_transcripts_per_gene' => $$non_coding_stats[10],
                              'genebuild.nc_total_exons' => $$non_coding_stats[11],
                              'genebuild.nc_average_exon_length' => $$non_coding_stats[12],
                              'genebuild.nc_average_exons_per_transcript' => $$non_coding_stats[13],
                              'genebuild.nc_total_introns' => $$non_coding_stats[14],
                              'genebuild.nc_average_intron_length' => $$non_coding_stats[15]);

  my %pseudogene_stats_hash = ('genebuild.ps_pseudogenes' => $$pseudogene_stats[1],
                               'genebuild.ps_average_genomic_span' => $$pseudogene_stats[2],
                               'genebuild.ps_average_sequence_length' => $$pseudogene_stats[3],
                               'genebuild.ps_shortest_gene_length' => $$pseudogene_stats[4],
                               'genebuild.ps_longest_gene_length' => $$pseudogene_stats[5],
                               'genebuild.ps_total_transcripts' => $$pseudogene_stats[6],
                               'genebuild.ps_transcripts_per_gene' => $$pseudogene_stats[7],
                               'genebuild.ps_total_exons' => $$pseudogene_stats[8],
                               'genebuild.ps_average_exon_length' => $$pseudogene_stats[9],
                               'genebuild.ps_average_exons_per_transcript' => $$pseudogene_stats[10],
                               'genebuild.ps_total_introns' => $$pseudogene_stats[11],
                               'genebuild.ps_average_intron_length' => $$pseudogene_stats[12]);

  my %assembly_stats_hash = ('assembly.contig_n50' => $$assembly_stats[7],
                             'assembly.total_genome_length' => $$assembly_stats[8],
                             'assembly.total_coding_sequence_length' => $$assembly_stats[9],
                             'assembly.total_gap_length' => $$assembly_stats[10],
                             'assembly.spanned_gaps' => $$assembly_stats[11],
                             'assembly.chromosomes' => $$assembly_stats[12],
                             'assembly.toplevel_sequences' => $$assembly_stats[13],
                             'assembly.component_sequences' => $$assembly_stats[14],
                             'assembly.gc_percentage' => $$assembly_stats[15]);
